...
ALTER TABLE registrations
    ADD CONSTRAINT reg_check_code_upper CHECK ( registration_code = upper(registration_code) );
...
CREATE OR REPLACE TRIGGER CAND_ID_SEQ_TRG 
BEFORE INSERT ON CANDIDATES 
FOR EACH ROW 
WHEN (NEW.CANDIDATE_ID IS NULL) 
BEGIN
:new.candidate_id := cand_id_seq.nextval;
